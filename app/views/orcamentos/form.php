            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="Orcamento.adicionarItem()">
...
$(document).ready(function() {
    // Inicializar eventos do primeiro item
    Orcamento.initItemEvents($('.orcamento-item').first());
